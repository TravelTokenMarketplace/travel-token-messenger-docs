...
![This image displays the Messenger bots installed in the partner's systems and the decentralized Messenger Server](/img/messenger/technical_infrastructure_messenger.png)
...
![This image displays the Messenger Search, Validate and Mint workflow](/img/messenger/stateful_flow.png)
...
![This image displays the scenario to upgrade to a new Camino Message Type Version](/img/messenger/version_transition.excalidraw.svg)
