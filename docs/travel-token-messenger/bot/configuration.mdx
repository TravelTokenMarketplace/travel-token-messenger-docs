...
`https://github.com/TravelTokenMarketplace/travel-token-messenger-bot/tree/VERSION/examples/config`

Example: https://github.com/TravelTokenMarketplace/travel-token-messenger-bot/tree/v10.1.0/examples/config
